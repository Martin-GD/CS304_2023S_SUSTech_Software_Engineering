  ...
  <div class="container" ref="container">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        ...
        <img class="panel-img" src="@/assets/atom.png"  style="width:100%;scale: 0.8" alt=""/>
      </div>
    ...
    <div class="forms-container">
      <div class="signin-signup">
        <div class="sign-in-form">
          <div class="login-form-title">登录Atom</div>
          <div class="login-form-sub-title">Sign in</div>
          ...
          <!-- :disabled="!canLogin" -->
          <a-button class="login-form-btn" type="primary"  @click="signIn()" long>
            {{$t('login')}}
          </a-button>
        </div>

        <div class="sign-up-form">
          <div class="login-form-title">注册 Atom</div>
          <div class="login-form-sub-title">注册 Atom</div>
          ...
          />
          <!-- :disabled="!canSignUp" -->
          <a-button class="login-form-btn" type="primary"  @click="signUp()" long>
            {{ $t('signup') }}
          </a-button>
...
.container {
  ...
  background-color: rgb(80, 153, 228);
  overflow: hidden;
}
...
.container::before {
  ...
  width: 50%;
  height: 100%;
  background-image: linear-gradient(-45deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 80%);
...
.panel {
  ...
  .panel-content{
    ...
    .panel-btn {
      ...
      height: 41px;
      outline: none;
      border: 2px solid rgb(80, 153, 228);
      border-radius: 49px;
      background: rgb(255, 255, 255);
      color: rgb(80, 153, 228);
      font-weight: 600;
...
.container.sign-up-mode::before {
  ...
  width: 50%;
  height: 100%;
  background-image: linear-gradient(-45deg, rgb(80, 241, 218) 0%, rgb(40, 48, 170) 80%);
}
